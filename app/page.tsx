...
import { MessageCircle, X, Send, Phone, Mail, MapPin, Users, Shield, Heart, FileText } from "lucide-react"
...
export default function ACSWebsite() {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm the ACS Virtual Assistant. How can I help you today?",
      sender: "bot",
      timestamp: new Date(),
    },
  ])
  ...
  // https://acs-chatbot.onrender.com
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">ACS</h1>
                <p className="text-sm text-gray-600">Administration for Children's Services</p>
              </div>
            </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Protecting Children,
            <span className="text-blue-900 block">Supporting Families</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-blue-900 text-blue-900 px-8 py-4 rounded-lg font-semibold hover:bg-blue-900 hover:text-white transition-colors">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Foster Care</h4>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Adoption Services</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-purple-700 rounded-lg flex items-center justify-center mb-6">
                <Shield className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Child Protection</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">OSI Investigations</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Family Support</h4>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Juvenile Justice</h4>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section id="about" className="py-20 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-4xl font-bold mb-6">About ACS</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-100">Children Served</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-200">5K+</div>
                  <div className="text-sm text-blue-100">Foster Families</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-200">100+</div>
                  <div className="text-sm text-blue-100">Community Partners</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
              ...
              <p className="text-blue-900 font-semibold text-lg">1-800-342-3720</p>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
              ...
              <p className="text-green-700 font-semibold">info@acs.nyc.gov</p>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-2">Main Office</h4>
              <p className="text-purple-700 font-semibold">150 William St</p>
              <p className="text-gray-600 text-sm mt-2">New York, NY 10038</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h5 className="text-xl font-bold">ACS</h5>
                  <p className="text-gray-400 text-sm">Administration for Children's Services</p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-2">Child Abuse Hotline</p>
              <p className="text-white font-semibold text-lg">1-800-342-3720</p>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center justify-center z-50 group"
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md h-[600px] flex flex-col overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold">ACS Virtual Assistant</h3>
            ...
            <div className="p-4 bg-white border-t border-gray-200">
              <form onSubmit={handleSendMessage} className="flex space-x-3">
                ...
                <button
                  ...
                  className="w-12 h-12 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center justify-center"
                >
